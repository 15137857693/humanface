...
public class facejudge extends JPanel {
    ...
    public static Mat detectFace(Mat img) throws Exception
    {
        ...
        CascadeClassifier faceDetector = new CascadeClassifier("D:\\opencv\\windows\\opencv4.2.0\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
